        ...
        <div className='container mx-auto'>
            ...
            <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
                ...
                <div className="dark:text-gray-800">
                    <p>Welcome to Rustic Chic Craft, where we blend the charm of rustic aesthetics with the elegance of chic design. Our passion lies in creating unique pieces that evoke warmth, nostalgia, and sophistication.</p>
                    <p>From handcrafted furniture to bespoke decor items, each creation at Rustic Chic Craft is infused with craftsmanship, attention to detail, and a touch of creativity. We believe in the power of craftsmanship to transform spaces and enrich lives.</p>
                </div>
                <div className="pt-12 border-t dark:border-gray-300">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 align-center">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Facebook" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
